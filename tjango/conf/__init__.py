...
"""
Settings and configuration for tjango.
Values will be read from the module specified by the TJANGO_SETTINGS_MODULE environment
variable, and then from tjango.conf.global_settings; see the global settings file for
...
from tjango.conf import global_setting

from tjango.exception import ImproperlyConfigured

ENVIRONMENT_VARIABLE = "TJANGO_SETTINGS_MODULE"
...
class setting:
    '''
    a lazy proxy for either global tjango setting or a custom setting object
    '''
    ...
    def configure(self, default_settings=global_setting, **options):
        """
